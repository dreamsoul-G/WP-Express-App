...
1. Refactor GUI with PySide6, build local lightweight SQLite database, and implement multi-threaded development (foundation for follow-up features);
...
> 1. 基于 PySide6 重构 GUI，搭建本地轻量级 SQLite 数据库，实现多线程开发（为后续功能打基础）；
